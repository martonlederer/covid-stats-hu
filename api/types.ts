...
export class TotalData {
  ...
  @Field(() => Int, { description: 'Total number of cases outside of Budapest' })
  ...
  @Field(() => Int, { description: 'Total number of deaths outside of Budapest' })
  ...
  @Field(() => Int, { description: 'Total number of recoveries outside of Budapest' })
  ...
  @Field(() => Float, { description: 'Rate of people with COVID-19 in Budapest' })
  caseRateBp: number // what percentage of Budapest is sick
  @Field(() => Float, { description: 'Rate of people with COVID-19 outside of Budapest' })
  caseRateOthers: number // what percentage outside of Budapest is sick
  @Field(() => Float, { description: 'Rate of people with COVID-19 in Hungary' })
  caseRate: number // what percentage of Hungary is sick
  @Field(() => Float, { description: 'Rate of people recovered from COVID-19 in Budapest' })
  recoveryRateBp: number // what percentage of Budapest has recovered
  @Field(() => Float, { description: 'Rate of people recovered from COVID-19 outside of Budapest' })
  recoveryRateOthers: number // what percentage outside of Budapest has recovered
  @Field(() => Float, { description: 'Rate of people recovered from COVID-19 in Hungary' })
  recoveryRate: number // what percentage of Hungary has recovered
  @Field(() => Float, { description: 'Rate of fatal COVID-19 cases in Budapest' })
  fatalityRateBp: number // fatal case rate in Budapest
  @Field(() => Float, { description: 'Rate of fatal COVID-19 cases outside of Budapest Budapest' })
  fatalityRateOthers: number // fatal case rate outside of Budapest
  @Field(() => Float, { description: 'Rate of fatal COVID-19 cases in Hungary' })
...
export class DayData {
  ...
  @Field(() => Int, { description: 'Additional cases in Budapest on the given day' })
  casesBp: number // additional cases in Budapest on the given day
  @Field(() => Int, { description: 'Additional cases outside of Budapest on the given day' })
  ...
  @Field(() => Int, { description: 'Additional fatal cases outside of Budapest on the given day' })
  ...
  @Field(() => Int, { description: 'Additional recoveries in Budapest on the given day' })
  recoveriesBp: number // additional recoveries in Budapest on the given day
  @Field(() => Int, { description: 'Additional recoveries outside of Budapest on the given day' })
